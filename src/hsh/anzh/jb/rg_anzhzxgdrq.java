...
public class rg_anzhzxgdrq extends android.widget.ScrollView {

    private ISmartScrollChangedListener mSmartScrollChangedListener;
    private boolean isScrolledToTop = true;
    private boolean isScrolledToBottom = false;
    public rg_anzhzxgdrq(android.content.Context context) {
        super(context);
    }
    public rg_anzhzxgdrq(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }
